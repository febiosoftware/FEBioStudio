...
QT_MOC_LITERAL(3, 24, 4) // "link"
    ...
    "TagLabel\0linkActivated\0\0link"
};
...
void TagLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TagLabel::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TagLabel::linkActivated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TagLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<WrapLabel::staticMetaObject>(),
    qt_meta_stringdata_TagLabel.data,
    qt_meta_data_TagLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TagLabel::qt_metacast(const char *_clname)
{
    ...
    return WrapLabel::qt_metacast(_clname);
}

int TagLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = WrapLabel::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
// SIGNAL 0
void TagLabel::linkActivated(const QString & _t1)
{
