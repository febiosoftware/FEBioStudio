...
CDlgAddIC::CDlgAddIC(FEProject& prj, QWidget* parent) : QDialog(parent), ui(new Ui::CDlgAddIC)
{
	setWindowTitle("Add Initial Condition");
	...
	// set the ic types
	vector<FEClassFactory*> l = FEMKernel::FindAllClasses(prj.GetModule(), FE_INITIAL_CONDITION);
