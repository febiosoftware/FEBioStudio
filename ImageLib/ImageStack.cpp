...
bool ImageStack::Create(int nx, int ny, int nz)
{
...
bool ImageStack::LoadFromFile(const char* szfile, int nbits)
{
...
void ImageStack::BitBlt(Image& im, int nslice)
{
...
void ImageStack::StretchBlt(Image& im, int nslice)
{
	byte* pd = im.GetBytes();
...
void ImageStack::StretchBlt(ImageStack& im)
{
	int nx = im.Width();
	int ny = im.Height();
	int nz = im.Depth();
...
byte ImageStack::Value(double fx, double fy, int nz)
{
	double r, s;
...
byte ImageStack::Peek(double r, double s, double t)
{
...
void ImageStack::Histogram(int* pdf)
{
	int i;
...
void ImageStack::GetSliceX(Image& im, int n)
{
	// create image data
...
void ImageStack::GetSliceY(Image& im, int n)
{
	// create image data
...
void ImageStack::GetSliceZ(Image& im, int n)
{
	// create image data
...
void ImageStack::GetSampledSliceX(Image& im, double f)
{
	// create image data
	if ((im.Width() != m_cy) || (im.Height() != m_cz)) im.Create(m_cy, m_cz);
...
void ImageStack::GetSampledSliceY(Image& im, double f)
{
	// create image data
	if ((im.Width() != m_cx) || (im.Height() != m_cz)) im.Create(m_cx, m_cz);
...
void ImageStack::GetSampledSliceZ(Image& im, double f)
{
	// create image data
	if ((im.Width() != m_cx) || (im.Height() != m_cy)) im.Create(m_cx, m_cy);
