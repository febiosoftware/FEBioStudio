...
CDlgAddContact::CDlgAddContact(FEProject& prj, QWidget* parent) : QDialog(parent), ui(new Ui::CDlgAddContact)
{
	setWindowTitle("Add Contact Interface");
	...
	// set the types
	vector<FEClassFactory*> l = FEMKernel::FindAllClasses(prj.GetModule(), FE_INTERFACE);
...
void CDlgAddContact::accept()
{
	...
	{
		QMessageBox::critical(this, windowTitle(), "Please select an interface type.");
		return;
	}
