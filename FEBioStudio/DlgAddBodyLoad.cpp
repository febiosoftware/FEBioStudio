...
CDlgAddBodyLoad::CDlgAddBodyLoad(FEProject& prj, QWidget* parent) : QDialog(parent), ui(new Ui::CDlgAddBodyLoad)
{
	setWindowTitle("Add Body Load");
	...
	// set the types
	vector<FEClassFactory*> l = FEMKernel::FindAllClasses(prj.GetModule(), FE_BODY_LOAD);
