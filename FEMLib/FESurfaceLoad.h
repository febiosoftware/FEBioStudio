...
//
class FESoluteNaturalFlux : public FESurfaceLoad
{
public:
    enum { SID, BSHL };
    
public:
    FESoluteNaturalFlux(FEModel* ps, FEItemListBuilder* pi = 0, int nstep = 0);
    ...
    FELoadCurve* GetLoadCurve() override { return nullptr; }
};
